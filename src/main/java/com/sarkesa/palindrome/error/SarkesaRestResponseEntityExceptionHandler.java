...
@Slf4j
public class SarkesaRestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    @Override
    ...
    protected void logError(final Exception exception,
        ...
        log.error("Error ID [{}] generated for exception [{}] caught when executing path [{}]. Exception message: [{}]",
            apiError.getId(), exception.getClass().getName(), apiError.getPath(), exception.toString());
